...
export function get_run_program() {
    return run_program
}

export function set_run_program(value) {
    run_program = value
    return run_program
}

import { initCAPI } from './capi/initCAPI'
const CAPI = initCAPI()
...
import { assembly_compiler } from './compiler/compiler'
import { executeProgramOneShot } from './executor/executor'
import { main_memory_get_addresses, main_memory_read_value, main_memory_read_default_value } from './memory/memoryCore'
        ...
        case 'error':
            ...
            if (ret.line > 0)
                ret.msg +=
                    ...
                    (ret.line + 0) +
                    ' ' +
                    code_assembly_segment[ret.line - 1] +
                    '\n'
            ret.msg +=
                '->' +
                (ret.line + 1) +
                ' ' +
                code_assembly_segment[ret.line] +
                '\n'
