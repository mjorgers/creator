 ...
 */
'use strict';
import { architecture, word_size_bytes } from '../core';
import { main_memory_write_bydatatype, main_memory_read_bydatatype, main_memory_reset, main_memory_clear, main_memory_get_addresses } from './memoryCore';
import { data_tag } from '../compiler/compiler';
import { creator_memory_updaterow, creator_memory_updateall, creator_memory_clearall } from './memoryViewManager';
import { creator_memory_zerofill, main_memory_storedata } from './memoryManager';
import { align } from '../compiler/compiler'
