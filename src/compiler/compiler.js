 ...
 */
'use strict';
import { architecture, architecture_hash, status, stats, stats_value, app, code_assembly, update_binary, backup_stack_address, backup_data_address } from '../core';
import { getFieldLength, generateBinary } from './binaryFieldUtils';
import { creator_memory_findaddress_bytag, creator_memory_prereset } from '../memory/memoryManager';
import { creator_memory_clear, creator_insert_instruction, writeMemory, creator_memory_data_compiler, creator_memory_storestring } from '../memory/memoryOperations';
import { register_value_deserialize, bi_intToBigInt } from '../utils/bigint';
import { creator_ga } from '../utils/creator_ga';
import { console_log } from '../utils/creator_logger.mjs';
import { bin2hex, hex2float, float2bin, hex2double, double2bin } from '../utils/utils';
