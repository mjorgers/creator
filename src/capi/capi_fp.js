 ...
 */
'use strict';
import { register_size_bits } from '../core';
import { bin2hex, double2bin, uint_to_float32, float32_to_uint, uint_to_float64, float64_to_uint, checkTypeIEEE, float2bin } from '../utils/utils';
