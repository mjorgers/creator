 ...
 */
'use strict';
import { bi_doubleToBigInt, bi_floatToBigInt } from '../utils/bigint';
import { architecture } from '../core';
import { readRegister } from './registerOperations';
import { bin2hex, float2bin, double2bin, hex2double, hex2float } from '../utils/utils';
